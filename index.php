...
<body>
    ...
    <div class="container">
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://tetthieunhi.mykingdom.com.vn/html/images/banner.jpg" class="d-block w-100"
                            alt="...">
                    </div>
                </div>
        ...
        <h3 style="text-decoration:wavy;">1. List of toys</h3>
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Baby toys</h1>
            <p class="lead">Referring to jigsaw puzzles without mentioning Lego is a huge omission! The first place on
                this list is for the Lego Duplo: Train to learn to count numbers.
                Some features of this toy set:

                Prestigious brand, proven quality and safety
                Made from high quality virgin plastic
                Includes many different puzzle pieces with large puzzle sizes to suit 2-year-olds
                This set of toys helps children develop their observation ability, the ability to handle situations,
                learn to count from 0 to 9 .
                Thanks to the movable wheels, it also helps children enhance movement.</p>
        </div>
    </div>
    <!-- Optional JavaScript -->
